...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/jquery.Jcrop.min.css" />
		...
		<div class="row">
			...
			<form:form action="resizeIt" method="POST">
					<div class="alert alert-info">
						<h2 class="control-label"> <b>Or select your favorite size : </b></h2> 
						<div class="form-inline">	
							<label class="radio"> 200 x 200 <input name="pic_size" value="200" type="radio"> |
							</label> 
							<label class="radio"> 400 x 400 <input name="pic_size" value="400" type="radio"> |
							</label> 
							<label class="radio"> 800 x 600 <input name="pic_size" value="600" type="radio"> |
							</label> 
							<label class="radio"> 1200 x 800 <input name="pic_size" value="800" type="radio">
							</label>
						</div>	
					</div>
